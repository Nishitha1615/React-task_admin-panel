  ...
  return (
    ...
    <p class="mb-4">Bootstrap's default utility classes can be found on the official <a href="https://getbootstrap.com/docs">Bootstrap Documentation</a> page. The custom utilities
      ...
      <div className="row pagecolor">
        <div class="col-lg-4">
          <div class="card shadow mb-4 color-page1">
          ...
          <div class="card shadow mb-4 card-text-color">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
        ...
        <div class="col-lg-4">
          <div class="card shadow mb-4 card-gradient">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
            ...
            <div class="card-body">
              <div class="px-3 py-5 bg-gradient-primary text-white left">
                .bg-gradient-primary
              </div>
        ...
        <div class="col-lg-4">
          <div class="card shadow mb-4 grayscale">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
